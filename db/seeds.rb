...
sarah = Craftman.new(
  {
    ...
    last_name: "Carrucan",
    phone: "61597946943",
    description: "Wood and life are inextricably connected, and wood is literally life to us. Therefore, we use solid wood from renewable resources in our production, only environmentally-friendly materials for treatment, natural oils and wax that emphasize the luxurious and organic beauty of wood texture and that enable it to 'breathe' naturally.",
...
workshop_attributes = [
  {
    title:        "Your scandi style wooden table in 3 days",
    price:        500000,
  ...
  {
    title:        "Create your own rocking chair",
    price:        180000,
  ...
  {
    title:        "Create your dream design desk",
    price:        40000,
